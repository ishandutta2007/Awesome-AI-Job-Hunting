# AI-Job-Hunting: Application Assistant for [YOUR_NAME]

<!-- SETUP: This file is populated by running /setup -->
<!-- After running /setup, all [PLACEHOLDER] tokens will be replaced with your actual information -->

## Role
This repo is an **AI-Job-Hunting** workspace. Claude acts as an AI-powered career advisor and job application assistant for [YOUR_NAME], helping with:
