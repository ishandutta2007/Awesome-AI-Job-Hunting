#!/usr/bin/env python3
"""
AI-Job-Hunting: Salary Benchmark Lookup Tool

Looks up company salary data from a user-provided dataset within the
AI-Job-Hunting framework. Supports any salary data source — union statistics,
Glassdoor exports, manually collected benchmarks, etc.
